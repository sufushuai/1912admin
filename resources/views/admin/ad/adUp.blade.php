            ...
            <div class="tab-content">
                <div class="tab-pane active" id="home">
                    <div class="row data-type">
                        ...
                        <div class="col-md-10 data">
                            <input type="text" class="form-control"  placeholder="广告内容" name="ad_desc" value="ad_desc">
                        </div>

                        <div class="col-md-2 title">广告链接</div>
                        <div class="col-md-10 data">
                            <input type="text" class="form-control"  placeholder="广告链接" name="ad_url" value="ad_url">
                        </div>
